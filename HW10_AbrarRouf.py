...
def litCricFriend(wordList, text):
    ...
    # One line of code.
    dashless_text = lower_case_text.replace('—', ' ')
    ...
    split_text = dashless_text.split()
    ...
    # Three lines of code.
    no_punctuation_text = [word.strip(string.punctuation) for word in split_text]
    ...
    counter = 0
    for element in no_punctuation_text:
    ...
    text_ratio = counter/len(no_punctuation_text)
    return text_ratio
...
print('Frequency of "a" and "an" for Poe:', litCricFriend(['a', 'an'], theBells))
print('Frequency of "the" for Poe:', litCricFriend(['the'], theBells))
print('Frequency of "a" and "an" for Neruda:', litCricFriend(['a', 'an'], cantoXII))
print('Frequency of "the" for Neruda:', litCricFriend(['the'], cantoXII))
...
'''
Yes, Poe uses "a" and "an" more frequently than Neruda does. 
Yes, Poe also uses "the" more frequently than Neruda does.
'''
